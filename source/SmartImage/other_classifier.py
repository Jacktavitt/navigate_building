# from https://github.com/kylepob/planeClassifier/blob/master/detectPlanes.py
## DATA PREPROCESSING ##
# Imports
import glob
import numpy as np
...
parser.add_argument("-v", "--visualize", type=HT.str2bool,
    nargs='?', const=True, help="Do you want to visualize?")
...
model.save_weights('plane_tut_model.h5')
model_json = model.to_json()
with open("plane_tut_model.json", "w") as jf:
    jf.write(model_json)
